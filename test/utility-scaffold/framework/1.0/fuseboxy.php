...
function framework__setFuseboxAPI() {
	global $fusebox;
...
function framework__loadDefaultConfig() {
	global $fusebox;
...
function framework__loadCustomConfig() {
	global $fusebox;
...
function framework__loadHelper() {
	global $fusebox;
...
// validate config
function framework__validateConfig() {
	global $fusebox;
...
function framework__urlRewrite() {
	global $fusebox;
...
function framework__formUrl2arguments() {
	global $fusebox;
...
function framework__setControllerAction() {
	global $fusebox;
